...
public interface UserDao {
   ...
   */
  User createUser(String username, String password) throws UsernameAlreadyExistsException;
   ...
   * @throws UsernameAlreadyExistsException If the specified username already exists in the database.
   */
  boolean updateUser(User user) throws UsernameAlreadyExistsException;
}
